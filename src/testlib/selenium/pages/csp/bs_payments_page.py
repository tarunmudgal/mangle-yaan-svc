...
class PaymentsPage(BasePage):
    ...
    def goto_payments_page(self):        
        ...
        if payments_page_link:
            ...
            assert self.find_element(self.commerce_payments_locators.TXT_PAYMENTS).text == "Manage Payment Methods", "Manage Payment Methods page is not working as expected"
            ...
            ), "could not find error msg locator={}".format(self.commerce_payments_locators.TXT_ERROR_MSG)
            assert self.if_element_exists(
