...
class CommercePaymentLocators:
    ...
    TXT_ERROR_MSG = (By.XPATH, "//p[contains(text(),'VMware Cloud commerce Services is undergoing sched')]")
    BTN_BACK_TO_HOME_PAGE = (By.XPATH, "//button[contains(text(),'Back to VMware cloud services')]")