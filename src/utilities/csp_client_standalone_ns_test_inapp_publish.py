...
LOGFILE_PATH = CURRENT_DIR + os.path.sep + "csp_client_standalone_ns_test_inapp_publish.log"
LOG_FORMAT = (
...
# initialize logger
mylog = logging.getLogger("csp_client_standalone_ns_test_inapp_publish")
...
if __name__ == "__main__":
    ...
    MESSAGE_TYPE_INAPP = "E2E_testPOBombardMessageType6"
    ...
    with open(ORGS_FILE_PATH) as fp:
        for org_id in fp:
            ...
            post_inapp_message_body = {
                ...
                "messageID": "164d9979-c1d7-44f5-88e0-7ec8bf95f370",
