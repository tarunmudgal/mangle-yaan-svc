...
from src.testlib.selenium.pages.csp.iam_page import ActiveUsersPage
from src.testlib.selenium.pages.csp.commerce_page import BillingAndSubscriptionsPage
...
class TestCSPPagesWhenCommerceEndpointsBlocked:
    ...
    def test_iam_commerce_pages_when_commerce_endpoints_blocked(self):
        ...
        bas_page = BillingAndSubscriptionsPage(self.driver,timeout = 60)
        subscription_status = bas_page.goto_subscriptions_page()
        assert (subscription_status == "VMware Cloud commerce Services is undergoing scheduled maintenance right now."),"scbscription page not working as expected"
